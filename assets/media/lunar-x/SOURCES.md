# Media sources, LunAR-X, Autonomous lunar regolith excavation

Regenerate with:  `python3 tools/make_media.py --slug lunar-x`

| file | source | clip |
|---|---|---|
| `hero` | https://raw.githubusercontent.com/Lunar-Autonomous-Regolith-Excavator/LunAR-X/devel/media/lunarx.gif | 2s +8s |
